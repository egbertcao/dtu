...
#=========================================================================
# File Name      : gpio.mak
# Description    : Main make file for the custom/eint package.
#
# Usage          : make [-s] -f eint.mak OPT_FILE=<path>/<opt_file>
#

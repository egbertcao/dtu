...
#
# Usage          : make [-s] -f dtu.mak OPT_FILE=<path>/<opt_file>
#
...
PACKAGE_SRC_FILES = dtu_main.c cJSON.c dtu_data_parase.c dtu_tool_config.c dtu_device_info.c dtu_get_config.c

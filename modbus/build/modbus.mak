...
#=========================================================================
# File Name      : modbus.mak
# Description    : Main make file for the modbus package.
#
# Usage          : make [-s] -f gpio.mak OPT_FILE=<path>/<opt_file>
#
...
PACKAGE_NAME     = modbus
PACKAGE_BASE     = custom
PACKAGE_DEP_FILE = modbus_dep.mak
...
PACKAGE_INC_PATHS   = ${PACKAGE_PATH}/src  ${PACKAGE_PATH}/inc ${PACKAGE_PATH}/src/rtu

ifneq (,$(findstring OPENCPU,${VARIANT_LISTDK_T}))
